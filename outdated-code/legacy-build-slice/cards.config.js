...
(function () {
    ...
    cycles: [
      {
        year: 1965,
        title: "找到生意",
        brief: "公司活下来了，但不能同时追逐每一笔合同、每一项发明和每一个人才。",
        opportunities: [
          { id: "E01", payoff: "现金或研究能力", risk: "合同会改变公司方向", deadline: "本周期" },
          { id: "E02", payoff: "技术或知识产权", risk: "公开与独占只能选一边", deadline: "2 个周期" },
          { id: "P01", payoff: "高级人才", risk: "需要股份与自主权", deadline: "本周期" },
          { id: "E03", payoff: "产品与市场", risk: "研发投入很高", deadline: "本周期" },
        ],
      },
      {
        year: 1971,
        title: "建立能力",
        brief: "订单开始增加。你需要决定公司靠研究、客户还是制造能力扩大优势。",
        opportunities: [
          { id: "E04", payoff: "制造基础", risk: "工厂会长期占用现金", deadline: "本周期" },
          { id: "E08", payoff: "市场或企业客户", risk: "宣传与交付争夺资源", deadline: "本周期" },
          { id: "S03", payoff: "下一代芯片技术", risk: "需要重做现有产品", deadline: "本周期" },
          { id: "E07", payoff: "品牌与市场", risk: "诉讼消耗现金", deadline: "2 个周期" },
        ],
      },
      {
        year: 1977,
        title: "放大优势",
        brief: "早年的选择开始形成惯性。继续投入能够启动飞轮，转向则可能补上致命短板。",
        opportunities: [
          { id: "E10", payoff: "升级制造体系", risk: "需要再次投入", deadline: "本周期" },
          { id: "E09", payoff: "长期订单", risk: "可能依赖单一客户", deadline: "本周期" },
          { id: "E11", payoff: "家庭电脑市场", risk: "产品窗口转瞬即逝", deadline: "本周期" },
          { id: "E12", payoff: "保卫市场", risk: "价格战或诉讼都昂贵", deadline: "本周期" },
        ],
      },
      {
        year: 1981,
        title: "危机准备",
        brief: "价格正在下跌，银行开始谨慎。最后两个行动将决定公司带着什么进入寒冬。",
        opportunities: [
          { id: "P02", payoff: "关键人才关系", risk: "旧承诺开始追账", deadline: "本周期" },
          { id: "E13", payoff: "低功耗技术或现金", risk: "能源成本正在上涨", deadline: "危机前" },
          { id: "E15", payoff: "设计自动化", risk: "短期投入巨大", deadline: "危机前" },
          { id: "E16", payoff: "库存控制或现金", risk: "判断错误会放大损失", deadline: "危机前" },
        ],
      },
    ],
    builds: {
      tech: {
        name: "技术先锋",
        tags: ["selfStart", "ownProduct", "shenEmployed", "consumerElectronics", "chipShift", "designAutomation"],
        bonus: { tech: 8, market: 4 },
        summary: "仪器、人才与产品开始互相加速。研发不再只是支出，而是持续制造新机会。",
      },
      customer: {
        name: "客户机器",
        tags: ["serviceBusiness", "enterpriseClients", "publicDemo", "exclusiveContract", "independentChannel"],
        bonus: { cash: 10, talent: -3 },
        summary: "客户开始介绍客户，订单形成稳定现金流，也把交付压力带进了办公室。",
      },
      manufacturing: {
        name: "韧性制造",
        tags: ["ownFactory", "outsourced", "modernFactory", "stableFoundry", "inventoryControlled"],
        bonus: { cash: 5, market: 5 },
        summary: "生产、供应与库存连成闭环，公司第一次能够把行业缺货变成自己的订单。",
      },
    },
    opportunityBuilds: {
      E01: ["customer"], E02: ["tech"], P01: ["tech"], E03: ["tech", "customer"],
      E04: ["manufacturing"], E08: ["customer"], S03: ["tech"], E07: ["tech"],
      E10: ["manufacturing"], E09: ["customer"], E11: ["tech", "customer"], E12: ["customer"],
      P02: ["tech"], E13: ["tech", "manufacturing"], E15: ["tech"], E16: ["manufacturing"],
    },
  };
  ...
  window.GAME_CONFIG = { cards, conditionalCards, companyActions, management, annual, slice, balance };
})();
